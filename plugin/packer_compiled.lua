...
_G.packer_plugins = {
  ...
  ["peek.nvim"] = {
    loaded = true,
    path = "/Users/m.manzanares/.local/share/nvim/site/pack/packer/start/peek.nvim",
    url = "https://github.com/cloudsftp/peek.nvim"
  },
  ["persisted.nvim"] = {
    loaded = true,
