...
local no_errors, error_msg = pcall(function()
	...
	local install_cpath_pattern =
		"/Users/m.manzanares/.cache/nvim/packer_hererocks/2.1.0-beta3/lib/lua/5.1/?.so"
	...
	_G.packer_plugins = {
		...
		["copilot-cmp"] = {
			after_files = {
				"/Users/m.manzanares/.local/share/nvim/site/pack/packer/opt/copilot-cmp/after/plugin/copilot_cmp.lua",
			},
			load_after = {
				["copilot.lua"] = true,
			},
