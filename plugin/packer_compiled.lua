...
_G.packer_plugins = {
  ...
  ["highlight-current-n.nvim"] = {
    loaded = true,
    path = "/Users/m.manzanares/.local/share/nvim/site/pack/packer/start/highlight-current-n.nvim",
  ...
  ["inc-rename.nvim"] = {
    loaded = true,
    path = "/Users/m.manzanares/.local/share/nvim/site/pack/packer/start/inc-rename.nvim",
  ...
  ["lua-dev.nvim"] = {
    loaded = true,
    path = "/Users/m.manzanares/.local/share/nvim/site/pack/packer/start/lua-dev.nvim",
  ...
  ["numbers.nvim"] = {
    loaded = true,
    path = "/Users/m.manzanares/.local/share/nvim/site/pack/packer/start/numbers.nvim",
  ...
  ["nvim-cursorline"] = {
    loaded = true,
    path = "/Users/m.manzanares/.local/share/nvim/site/pack/packer/start/nvim-cursorline",
