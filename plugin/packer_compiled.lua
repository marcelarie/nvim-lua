...
_G.packer_plugins = {
  ...
  ["nvim-treesitter-endwise"] = {
    loaded = true,
    path = "/home/marcel/.local/share/nvim/site/pack/packer/start/nvim-treesitter-endwise",
  ...
  ["telescope-fzf-native.nvim"] = {
    loaded = true,
    path = "/home/marcel/.local/share/nvim/site/pack/packer/start/telescope-fzf-native.nvim",
